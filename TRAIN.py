...
Train_Image_Dir="C:/Users/Sophie/Fully-convolutional-neural-network-FCN-for-semantic-segmentation-Tensorflow-implementation/Data_Zoo/Materials_In_Vessels/Train_Images/" # Images and labels for training
Train_Label_Dir="C:/Users/Sophie/Fully-convolutional-neural-network-FCN-for-semantic-segmentation-Tensorflow-implementation/Data_Zoo/Materials_In_Vessels/LiquidSolidLabels/"# Annotetion in png format for train images and validation images (assume the name of the images and annotation images are the same (but annotation is always png format))
UseValidationSet=False# do you want to use validation set in training
Valid_Image_Dir="C:/Users/Sophie/Fully-convolutional-neural-network-FCN-for-semantic-segmentation-Tensorflow-implementation/Data_Zoo/Materials_In_Vessels/Test_Images_All/"# Validation images that will be used to evaluate training
Valid_Labels_Dir="C:/Users/Sophie/Fully-convolutional-neural-network-FCN-for-semantic-segmentation-Tensorflow-implementation/Data_Zoo/Materials_In_Vessels/LiquidSolidLabels/"#  (the  Labels are in same folder as the training set)
logs_dir= "C:/Users/Sophie/Fully-convolutional-neural-network-FCN-for-semantic-segmentation-Tensorflow-implementation/Model_Zoo/logs/"# "path to logs directory where trained model and information will be stored"
#if not os.path.exists(logs_dir): os.makedirs(logs_dir)
model_path="C:/Users/Sophie/Fully-convolutional-neural-network-FCN-for-semantic-segmentation-Tensorflow-implementation/Model_Zoo/vgg16.npy"# "Path to pretrained vgg16 model for encoder"
...
#MAX_ITERATION = int(200) # Max  number of training iteration
