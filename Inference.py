...
logs_dir= "C:/Users/Sophie/Fully-convolutional-neural-network-FCN-for-semantic-segmentation-Tensorflow-implementation/logs"# "path to logs directory where trained model and information will be stored"
Image_Dir="C:/Users/Sophie/Fully-convolutional-neural-network-FCN-for-semantic-segmentation-Tensorflow-implementation/Data_Zoo/Materials_In_Vessels/Test_Images_All/"# Test image folder
w=0.6# weight of overlay on image
Pred_Dir="C:/Users/Sophie/Fully-convolutional-neural-network-FCN-for-semantic-segmentation-Tensorflow-implementation/Output_Prediction/" # Library where the output prediction will be written
